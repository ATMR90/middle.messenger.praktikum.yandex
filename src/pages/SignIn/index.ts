      ...
      new Button({
        ...
        events: {
          click: () => {
            ...
            const logLog = document.querySelector((`#${(this.children.fields as Array<any>)[0].props.idInput}`) as any).value;
            const logPass = document.querySelector((`#${(this.children.fields as Array<any>)[1].props.idInput}`) as any).value;
